...
import org.springframework.security.config.annotation.authentication.configuration.AuthenticationConfiguration; // Asegúrate de que esta importación esté presente
